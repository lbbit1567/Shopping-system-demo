...
class PageBar
{
    ...
    public function makeBar($url_page = "none")
    {
        ...
        while ($i <= $this->pTotal && $i <= ($this->pCurrent * $this->pLimit)) {
            if($this->current<=5 && $this->pTotal > 8){  // 列表印頭1-7
              for($j=1;$j<=7;$j++){
                ...
                if($j == $this->current){
                  ...
                  <li class='page-item active'>
                    <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$j}{$loadtime}' title='{$j}'>{$j}<span class='sr-only'>(current)</span></a>
                  </li>";
                }else{
                  $bar_center .="
                    <li class='page-item'>
                      <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$j}{$loadtime}' title='{$j}'>{$j}</a>
                    </li>";
                }
              }
                ...
                $bar_center .="
                <li class='page-item'>
                  <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$this->pTotal}{$loadtime}' title='{$this->pTotal}'>{$this->pTotal}</a>
                </li>";

                $i=$this->pTotal;

            }elseif($this->current > 5 && $this->current < $this->pTotal - 5 && $this->pTotal > 8 ){  //列表印中
                $bar_center .="
                <li class='page-item'>
                ...
                $displayPtoN = $this->current -2;
                for($k=1;$k<=5;$k++){
                  if($k == 3){
                    $bar_center = "
                    {$bar_center}
                    <li class='page-item active'>
                      <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$displayPtoN}{$loadtime}' title='{$displayPtoN}'>{$displayPtoN}<span class='sr-only'>(current)</span></a>
                    </li>";
                  }else{
                    $bar_center .="
                      <li class='page-item'>
                        <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$displayPtoN}{$loadtime}' title='{$displayPtoN}'>{$displayPtoN}</a>
                      </li>";
                  }
                  $displayPtoN++;
                }
            ...
            }elseif($this->current >= $this->pTotal - 5 && $this->pTotal > 8){  //列表印尾
              $bar_center .="
              <li class='page-item'>
                <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$i}{$loadtime}' title='{$i}'>{$i}</a>
              </li>";
              ...
              $displayLast = $this->current - 2;
              for($k=1; $k <= $this->pTotal - ($this->current - 3 ) ;$k++){
                if($displayLast == $this->current){
                  $bar_center = "
                  {$bar_center}
                  <li class='page-item active'>
                    <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$displayLast}{$loadtime}' title='{$displayLast}'>{$displayLast}<span class='sr-only'>(current)</span></a>
                  </li>";
                }else{
                  $bar_center .="
                    <li class='page-item'>
                      <a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$displayLast}{$loadtime}' title='{$displayLast}'>{$displayLast}</a>
                    </li>";
                }
                $displayLast++;
              }
        ...
        if ($this->current <= 1) {
            ...
            $i         = $this->current - 1;
            $bar_left  = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$i}{$loadtime}' title='回上頁'>&lsaquo;</a></li>";
            $bar_first = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}=1{$loadtime}' title='回第一頁' >&laquo;</a></li>";
        }
        ...
        if ($this->current >= $this->pTotal) {
            ...
            $i         = $this->current + 1;
            $bar_right = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$i}{$loadtime}' title='下一頁'>&rsaquo;</a></li>";
            $bar_last  = "<li class='page-item'><a class='page-link' href='{$this->to_page}{$this->query_str}{$this->glue}{$this->url_page}={$this->pTotal}{$loadtime}' title='上一頁' >&raquo;</a></li>";
        }
